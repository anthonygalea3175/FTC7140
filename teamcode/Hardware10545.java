...
public class Hardware10545
{
    ...
    public void init(HardwareMap ahwMap) {
        ...
        scissor    = hwMap.dcMotor.get("scissor");
        ...
        forklift.setDirection(DcMotor.Direction.REVERSE);// Set to FORWARD if using AndyMark motors
        scissor.setDirection(DcMotor.Direction.FORWARD);// Set to FORWARD if using AndyMark motors
        ...
        scissor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
    }
